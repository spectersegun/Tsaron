    ...
    if ($("#north-america-chart").length) {
      ...
      var areaOptions = {
        ...
        legendCallback: function (chart) {
          ...
          text.push(
            '<div className="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div className="d-flex align-items-center"><div className="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' +
              chart.data.datasets[0].backgroundColor[0] +
              '"></div><p className="mb-0">Offline sales</p></div>'
          );
          ...
          text.push(
            '<div className="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div className="d-flex align-items-center"><div className="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' +
              ...
              '"></div><p className="mb-0">Online sales</p></div>'
          );
          ...
          text.push(
            '<div className="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div className="d-flex align-items-center"><div className="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' +
              ...
              '"></div><p className="mb-0">Returns</p></div>'
          );
